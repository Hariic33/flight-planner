...
public class FlightDatabaseService implements FlightService {
    ...
    public synchronized Flight addFlight(Flight flight) {
        ...
        validateFlightRequest(from, to, departureTime, arrivalTime, carrier);

        return flightRepository.saveAndFlush(flight);
    }

    static void validateFlightRequest(Airport from, Airport to, LocalDateTime departureTime, LocalDateTime arrivalTime, String carrier) {
    ...
    public List<Airport> searchAirports(String search) {
        return flightRepository.searchAirports(search.toLowerCase().trim());
    }
    ...
    public Map<String, Object> searchFlights(FlightDTO dto) {
        ...
        List<Flight> flights = flightRepository.searchForFlight(
                dto.getFrom(), dto.getTo(), dto.getDepartureDate()
        );
